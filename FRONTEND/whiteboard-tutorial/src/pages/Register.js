  ...
  return (
    <div className={`min-h-screen w-full flex flex-col transition-colors duration-300 ${isDarkMode ? 'bg-black' : 'bg-slate-50'}`}>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-4 relative z-10 w-full mb-12">
        ...
        {/* Register Card */}
        <div
          className={`w-full max-w-sm p-8 rounded-2xl shadow-2xl backdrop-blur-xl border transition-all duration-300 relative z-20 mt-4 md:mt-0`}
          style={{
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className={`mt-3 text-sm font-medium ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
              Join us to start creating amazing whiteboards.
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            <div className="space-y-1.5">
              <label
                htmlFor="name"
                className={`block text-xs font-bold tracking-wide uppercase ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}
              >
                Full Name
              </label>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Min 8 chars, uppercase, lower, number"
                  required
                  className={`w-full px-4 py-3 rounded-lg outline-none transition-all duration-200 border-2
                    ${isDarkMode
                      ? 'bg-neutral-900 border-neutral-800 text-white placeholder-neutral-500 focus:bg-black focus:border-white focus:ring-1 focus:ring-white focus:ring-offset-0'
            ...
            {error && (
              <div className={`p-4 rounded-lg flex items-center space-x-3 backdrop-blur-md border animate-in fade-in slide-in-from-top-2 mt-4
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-3.5 px-4 mt-6 rounded-lg font-bold tracking-wide
